...
<head>
    ...
    <!-- Main css -->
    <link rel="stylesheet" href="{{ asset('frontend/v2') }}/css/main.css?v=1.5">
    <!-- Alert -->
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
   
   
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-H40C3SNCFT"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'G-H40C3SNCFT');
    </script>
...
<!-- Google Tag Manager  by Anower-->
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-N998QWL9');</script>
...
<script>
  ...
  fbq('init', '357341633807893'); 
  fbq('track', 'PageView');
</script>
<noscript>
  <img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=357341633807893&ev=PageView&noscript=1"/>
</noscript>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-N998QWL9"
...
<!-- End Google Tag Manager (noscript) -->
	...
	<!-- footer section -->
    <footer class="footer-area anower  overflow--hidden">
    ...
    <style>
        ...
        .whatsapp-button {
          background-color: rgb(37, 50, 136); /* A green color similar to the screenshot */
          color: white; /* Sets text and icon color to white */
          display: flex; /* Aligns icon and text side-by-side */
          align-items: center; /* Vertically centers the content */
          padding: 7px 30px; /* Adjusts the size of the button */
        ...
        .whatsapp-button i {
          font-size: 28px; /* Makes the icon a bit larger than the text */
...
<div class="whatsapp-container">
  <a href="https://wa.link/8riuag" class="whatsapp-button" target="_blank">
